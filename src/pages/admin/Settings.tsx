    ...
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
          <MdSettings className="text-cyan-600" />
          Settings
        </h1>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            <MdSecurity className="text-cyan-600" />
            Account Information
          </h2>
          <div className="space-y-4">
            <div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
            <MdNotifications className="text-cyan-600" />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Receive email notifications for admin events
                </p>
              </div>
              <button
                onClick={() => setEmailNotifications(!emailNotifications)}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Get notified about new study abroad applications
                </p>
              </div>
              <button
                onClick={() => setApplicationAlerts(!applicationAlerts)}
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              <span className="text-gray-600">Amadeus API</span>
